...
func main() {
	...
	structs.Movies = append(structs.Movies, structs.Movie{ID: "1", Isbn: "438227", Title: "Movie 1", Director: &structs.Director{Firstname: "John", Lastname: "Doe"}})
	structs.Movies = append(structs.Movies, structs.Movie{ID: "2", Isbn: "45455", Title: "Movie 2", Director: &structs.Director{Firstname: "Jane", Lastname: "Doe"}})
